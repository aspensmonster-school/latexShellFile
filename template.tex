...
\IEEEPARstart{T}{his} lab studies resistors in series, and the various measurements across them. It intends to verify Ohm's Law. It also intends to determine the maximum voltage that can be applied from the voltage source before a resistor suffers catastrophic failure. A schematic is below
